...
class id<1> : public detail::index_array_operators<1, cl::sycl::id> {
 public:
   ...
   */
  id(void) : detail::index_array_operators<1, cl::sycl::id>(0, 0, 0) {}
...
class id<2> : public detail::index_array_operators<2, cl::sycl::id> {
 public:
   ...
   * @brief Default constructor for id, initialized to { 0, 0, 0 }
   */
  id(void) : detail::index_array_operators<2, cl::sycl::id>(0, 0, 0) {}
  ...
  /*!
   * @brief conversion to int2 vector as a useful conversion for accessing image
   * coordinates.
   */
  operator int2() const {
...
class id<3> : public detail::index_array_operators<3, cl::sycl::id> {
 public:
   ...
   */
  id(void) : detail::index_array_operators<3, cl::sycl::id>(0, 0, 0) {}
  ...
  /*!
   * @brief conversion to int3 vector as a useful conversion for accessing image
   * coordinates.
   */
  operator int3() const {
