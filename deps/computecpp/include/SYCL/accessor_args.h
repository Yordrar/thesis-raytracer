...
#ifndef RUNTIME_INCLUDE_SYCL_ACCESSOR_ARGS_H_
#define RUNTIME_INCLUDE_SYCL_ACCESSOR_ARGS_H_
...
/*!
 * @brief Container of 4 integer indexes which are stored as sized integer types
 * such that an instance is equal to the sizeof(size_t). Provides a subscript
 * operator which returns an element of the index, converted to size_t.
 */
class device_index_array {
 public:
  ...
  /*!
   * @brief Returns an index based on the offset specified, converted to size_t.
...
#endif  // RUNTIME_INCLUDE_SYCL_ACCESSOR_ARGS_H_
