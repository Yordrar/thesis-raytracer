 ...
 * @return Same data, promoted to a type with double the width.
 */
constexpr cl_long double_width_cast(const cl_int from) noexcept { return from; }
 ...
 * @return Same data, promoted to a type with double the width.
 */
inline cl_float double_width_cast(const half from) noexcept { return from; }
...
/**
 * @brief Narrows the type of the input parameter to a type with half its width.
 * @param from The type to convert.
 * @return Same data, promoted to a type with half the width.
 */
constexpr cl_char halve_width_cast(const cl_char from) noexcept { return from; }
 ...
 * @return Same data, promoted to a type with half the width.
 */
inline half halve_width_cast(const half from) noexcept { return from; }
