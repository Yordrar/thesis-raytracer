...
/**
 * @brief A "tuple" of an associated binary_info structure and arguments to call
 * a kernel with.
 *
...
struct kernel_definition {
  ...
  const std::array<bool, NArgs> arguments;
};
...
template <typename T>
const kernel_definition<0> kernel_info<T>::bin_info[] = {{0, {{}}}};
...
struct functor_arg_descriptor {
  template <typename T>
  functor_arg_descriptor(const kernel_info<T>&, const bool* used,
                         const size_t nargs)
...
size_t construct_linear_row_major_index(size_t index0, size_t index1,
                                        size_t index2, size_t, size_t range1,
                                        size_t range2) {
...
*/
template <>
inline size_t construct_linear_row_major_index<2>(size_t index0, size_t index1,
                                                  size_t, size_t, size_t range1,
                                                  size_t) {
...
*/
template <>
inline size_t construct_linear_row_major_index<1>(size_t index0, size_t, size_t,
