...
*/
#ifndef RUNTIME_INCLUDE_SYCL_SYCL_MATH_BUILTINS_COMMON_H_
#define RUNTIME_INCLUDE_SYCL_SYCL_MATH_BUILTINS_COMMON_H_
...
/**
 * @brief Returns 1.0 if x > 0, -0.0 if x = -0.0, +0.0 if x = +0.0, or -1.0 if x
 * < 0. Returns 0.0 if x is a NaN.
 * @tparam F must model genfloat.
 */
template <typename F, typename return_t = detail::collapse_swizzled_vec_t<F>,
          COMPUTECPP_REQUIRES(detail::builtin::is_genfloat<F>::value)>
...
#endif  // RUNTIME_INCLUDE_SYCL_SYCL_MATH_BUILTINS_COMMON_H_
