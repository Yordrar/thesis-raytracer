...
class COMPUTECPP_EXPORT stream {
 ...
 private:
  /*!
  @brief Implementation detail member function for dumping the contents of the
  buffer to a string_class.
  */
  string_class dump() const;
...
void append_hexidecimal(const stream& os, const valueT& value) {
  ...
  for (int i = (currentDigit - 1); i >= 0; i--) {
    char character = (digits[i] <= 9) ? detail::to_char(digits[i])
                                      : ('A' + (digits[i] - 10));
...
inline void append_floating_point(const stream& os, const valueT& value) {
  ...
  /* Create an array to store the digits retrieved from the value. */
  valueT digits[MAX_FRACTIONAL_DIGITS] = {0.0f};
  ...
  for (int i = 0; i < (digitsForFractionalSide - 1); i++) {
    ...
    valueT currentMultiplier = 10.0f;
    for (int m = 0; m < i; m++) {
    ...
    for (int r = 0; r < i; r++) {
      ...
      multipliedFloat -= (digits[r] * currentStageMultiplier);
    }
...
struct stream_vec<2, true, elementT, kDimensions> {
  ...
  */
  inline const stream& operator()(const stream& os,
                                  const vec<elementT, kDimensions>& rhs) {
    vec<elementT, kDimensions>& mutableVec =
        const_cast<vec<elementT, kDimensions>&>(rhs);
    stream_value(os, static_cast<elementT>(mutableVec.x()));
    stream_value(os, COMPUTECPP_VEC_ELEM_DELIMITER);
    stream_value(os, static_cast<elementT>(mutableVec.y()));
    return os;
  }
};
  ...
  */
  inline const stream& operator()(const stream& os,
    ...
    vec<elementT, kDimensions>& mutableVec =
        const_cast<vec<elementT, kDimensions>&>(rhs);
    stream_value(os, COMPUTECPP_VEC_ELEM_DELIMITER);
    stream_value(os, static_cast<elementT>(mutableVec.z()));
    return os;
  }
};
  ...
  */
  inline const stream& operator()(const stream& os,
    ...
    vec<elementT, kDimensions>& mutableVec =
        const_cast<vec<elementT, kDimensions>&>(rhs);
    stream_value(os, COMPUTECPP_VEC_ELEM_DELIMITER);
    stream_value(os, static_cast<elementT>(mutableVec.w()));
    return os;
  }
};
...
struct stream_vec<8, true, elementT, kDimensions> {
  ...
  */
  inline const stream& operator()(const stream& os,
    ...
    vec<elementT, kDimensions>& mutableVec =
        const_cast<vec<elementT, kDimensions>&>(rhs);
    stream_value(os, static_cast<elementT>(mutableVec.s0()));
    stream_value(os, COMPUTECPP_VEC_ELEM_DELIMITER);
    stream_value(os, static_cast<elementT>(mutableVec.s1()));
    stream_value(os, COMPUTECPP_VEC_ELEM_DELIMITER);
    stream_value(os, static_cast<elementT>(mutableVec.s2()));
    stream_value(os, COMPUTECPP_VEC_ELEM_DELIMITER);
    stream_value(os, static_cast<elementT>(mutableVec.s3()));
    stream_value(os, COMPUTECPP_VEC_ELEM_DELIMITER);
    stream_value(os, static_cast<elementT>(mutableVec.s4()));
    stream_value(os, COMPUTECPP_VEC_ELEM_DELIMITER);
    stream_value(os, static_cast<elementT>(mutableVec.s5()));
    stream_value(os, COMPUTECPP_VEC_ELEM_DELIMITER);
    stream_value(os, static_cast<elementT>(mutableVec.s6()));
    stream_value(os, COMPUTECPP_VEC_ELEM_DELIMITER);
    stream_value(os, static_cast<elementT>(mutableVec.s7()));
    return os;
  }
};
  ...
  */
  inline const stream& operator()(const stream& os,
    ...
    vec<elementT, kDimensions>& mutableVec =
        const_cast<vec<elementT, kDimensions>&>(rhs);
    stream_value(os, COMPUTECPP_VEC_ELEM_DELIMITER);
    stream_value(os, static_cast<elementT>(mutableVec.s8()));
    stream_value(os, COMPUTECPP_VEC_ELEM_DELIMITER);
    stream_value(os, static_cast<elementT>(mutableVec.s9()));
    stream_value(os, COMPUTECPP_VEC_ELEM_DELIMITER);
    stream_value(os, static_cast<elementT>(mutableVec.sA()));
    stream_value(os, COMPUTECPP_VEC_ELEM_DELIMITER);
    stream_value(os, static_cast<elementT>(mutableVec.sB()));
    stream_value(os, COMPUTECPP_VEC_ELEM_DELIMITER);
    stream_value(os, static_cast<elementT>(mutableVec.sC()));
    stream_value(os, COMPUTECPP_VEC_ELEM_DELIMITER);
    stream_value(os, static_cast<elementT>(mutableVec.sD()));
    stream_value(os, COMPUTECPP_VEC_ELEM_DELIMITER);
    stream_value(os, static_cast<elementT>(mutableVec.sE()));
    stream_value(os, COMPUTECPP_VEC_ELEM_DELIMITER);
    stream_value(os, static_cast<elementT>(mutableVec.sF()));
    return os;
  }
};
