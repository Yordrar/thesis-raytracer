...
*/
#ifndef RUNTIME_INCLUDE_SYCL_SYCL_MATH_BUILTINS_RELATIONAL_H_
#define RUNTIME_INCLUDE_SYCL_SYCL_MATH_BUILTINS_RELATIONAL_H_
...
/**
 * Each bit of the result is the corresponding bit of a if the corresponding bit
 * of c is 0.
 *
...
#endif  // RUNTIME_INCLUDE_SYCL_SYCL_MATH_BUILTINS_RELATIONAL_H_
