...
/**
* @brief Implementation of a device_selector that selects either a CPU or a GPU,
  and falls back to a host mode device if none can be found.
*/
class COMPUTECPP_EXPORT default_selector : public device_selector {
 protected:
   ...
   */
  explicit default_selector(std::string target);
 ...
 public:
   ...
   * @brief Empty destructor.
   */
  virtual ~default_selector() = default;
...
class COMPUTECPP_EXPORT opencl_selector : public device_selector {
 public:
   ...
   * @brief Empty destructor.
   */
  virtual ~opencl_selector() = default;
...
/**
 * @brief Implementation of a device_selector that selects an accelerator device
 */
...
class COMPUTECPP_EXPORT intel_selector : public device_selector {
 public:
   ...
   * @brief Empty destructor.
   */
  virtual ~intel_selector() = default;

  /**
  * @brief Overload that scores devices with an Intel platform positive if they
    have SPIR support.
  * @param device The device that is to be scored.
  * @return an integer representing the allocated score for the device.
  */
