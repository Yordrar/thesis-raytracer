...
*/
#ifndef RUNTIME_INCLUDE_SYCL_SYCL_MATH_BUILTINS_FLOATING_POINT_H_
#define RUNTIME_INCLUDE_SYCL_SYCL_MATH_BUILTINS_FLOATING_POINT_H_
...
/**
 * @brief Returns the correctly rounded floating-point representation of the sum
 * of c with the infinitely precise product of a and b.
 *
...
/**
 * @brief Round to integral value (using round to nearest even rounding mode) in
 * floating-point format. Refer to section 7.1 of the OpenCL 1.2 specification
 * document for description of rounding modes.
 * @tparam F must model genfloat.
 */
template <typename F, typename return_t = detail::collapse_swizzled_vec_t<F>,
          COMPUTECPP_REQUIRES(detail::builtin::is_genfloat<F>::value)>
...
#endif  // RUNTIME_INCLUDE_SYCL_SYCL_MATH_BUILTINS_FP_H_