...
*/
#ifndef RUNTIME_INCLUDE_SYCL_ACCESSOR_OPS_H_
#define RUNTIME_INCLUDE_SYCL_ACCESSOR_OPS_H_
...
class subscript_op {
  ...
  */
  using accessor_t =
      detail::accessor_common<elemT, kAccDims, kMode, kTarget, isPlaceholder>;
...
#endif  // RUNTIME_INCLUDE_SYCL_ACCESSOR_OPS_H_
