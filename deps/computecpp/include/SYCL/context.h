...
class COMPUTECPP_EXPORT context {
 public:
   ...
   * @param An optional async_handler for the context
   */
  explicit context(async_handler asyncHandler = nullptr);

  /**
   * @brief Constructs a context object using a cl_context object.
   * @param context A cl_context object.
   * @param An optional async_handler for the context
   */
  explicit context(cl_context context, async_handler asyncHandler = nullptr);
   ...
   * @deprecated OpenGL interop no longer supported in SYCL 1.2.1
   */
  COMPUTECPP_DEPRECATED_API("Context constructor is deprecated")
   ...
   * @param device A reference to a device object.
   * @param asyncHandler An optional parameter to specify the async_handler
   * associated with the context.
   */
   ...
   * provided.
   * @param platform A reference to a platform object.
   * @param asyncHandler An optional parameter to specify the async_handler
   * associated with the context.
   */
   ...
   */
  context(const context& rhs) : m_impl{rhs.get_impl()} {}

  /**
   * @brief Constructs a context object by moving another device object.
   */
  context(context&& rhs) : m_impl{std::move(rhs.m_impl)} {}
