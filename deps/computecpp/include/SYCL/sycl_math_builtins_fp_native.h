...
*/
#ifndef RUNTIME_INCLUDE_SYCL_SYCL_MATH_BUILTINS_FP_NATIVE_H_
#define RUNTIME_INCLUDE_SYCL_SYCL_MATH_BUILTINS_FP_NATIVE_H_
...
#endif  // RUNTIME_INCLUDE_SYCL_SYCL_MATH_BUILTINS_FP_NATIVE_H_
