...
/*! non-member less comparison operator of two index_array_operatorss of the
 * same dimensionality.
...
/*! non-member comparison less operator of two index_array_operatorss of the
 * same dimensionality.
 * \param[in] a input typename index_array_operators<dimensions,
 * Child>::Concrete object \param[in] b input typename
 * index_array_operators<dimensions, Child>::Concrete object \returns a typename
...
/*! non-member comparison less or equal operator of two index_array_operatorss
 * of the
 * same dimensionality.
 * \param[in] a input typename index_array_operators<dimensions,
 * Child>::Concrete object \param[in] b input typename
