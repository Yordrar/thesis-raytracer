...
template <int dims, class kernelT, class functorT>
__attribute__((__sycl_kernel(kernelT))) __attribute__((__offload__)) void
...
*/
COMPUTECPP_SYCL_DEVFUNC bool __computecpp_access_hierarchical_region_() {
 ...
 * fence.
 */
COMPUTECPP_SYCL_DEVFUNC void __computecpp_merge_hierarchical_local_region_() {
 ...
 * fence.
 */
COMPUTECPP_SYCL_DEVFUNC void __computecpp_merge_hierarchical_global_region_() {
  ::cl::sycl::detail::barrier(::cl::sycl::detail::get_cl_mem_fence_flag(
