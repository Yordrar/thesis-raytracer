...
class buffer : public buffer_mem {
  ...
  */
  buffer(const range<dimensions>& r, const property_list& propList = {})
      : buffer_mem(
            ...
            r, sizeof(T), detail::pointer_origin::none,
  ...
  buffer(T* hostPointer, const range<dimensions>& r,
      ...
      : buffer_mem(
            std::move(shared_ptr_class<void>(static_cast<void*>(hostPointer),
                                             detail::NullDeleter())),
            dimensions, r, sizeof(T), detail::pointer_origin::raw,
            detail::make_base_allocator<T, AllocatorT>::get_buffer_allocator(),
            propList) {}
  ...
  */
  buffer(const T* hostPointer, const range<dimensions>& r,
         const property_list& propList = {})
      : buffer_mem(
            detail::clone_data<T, AllocatorT>(hostPointer, r.size()),
            dimensions, r, sizeof(T), detail::pointer_origin::raw_const,
            detail::make_base_allocator<T, AllocatorT>::get_buffer_allocator(),
            propList) {}
  ...
  */
  buffer(const T* hostPointer, const range<dimensions>& r, AllocatorT allocator,
         const property_list& propList = {})
      : buffer_mem(
            detail::clone_data<T>(hostPointer, r.size(), allocator), dimensions,
            r, sizeof(T), detail::pointer_origin::raw_const,
            detail::make_base_allocator<T, AllocatorT>::get_buffer_allocator(
                allocator),
            propList) {}
  ...
  */
  buffer(const shared_ptr_class<T>& hostPointer,  // NOLINT(runtime/references)
      ...
      : buffer_mem(
            hostPointer, dimensions, r, sizeof(T),
  ...
  */
  ...
  buffer(cl_mem mem_object, queue& fromQueue,  // NOLINT(runtime/references)
      ...
      : buffer_mem(
            mem_object, fromQueue, available_event, dimensions, sizeof(T),
  ...
  */
  buffer(cl_mem mem_object,
         ...
         event available_event = event())
      : buffer_mem(
            mem_object, syclContext, available_event, dimensions, sizeof(T),
            detail::make_base_allocator<T,
                                        AllocatorT>::get_buffer_allocator()) {}
  ...
  */
  explicit buffer(vector_class<T>& v,  // NOLINT(runtime/references)
      ...
      : buffer_mem(shared_ptr_class<T>(v.data(), detail::NullDeleter()),
                   ...
                   sizeof(T), detail::pointer_origin::raw,
  ...
  buffer(Iterator begin, Iterator end, const property_list& propList = {})
      : buffer_mem(
            detail::clone_data<T, AllocatorT>(begin, end), dimensions,
  ...
  buffer(Iterator begin, Iterator end, AllocatorT allocator,
         const property_list& propList = {})
      : buffer_mem(
            detail::clone_data<T>(begin, end, allocator), dimensions,
            range<1>(std::distance(begin, end)), sizeof(T),
            detail::pointer_origin::raw_const,
            detail::make_base_allocator<T, AllocatorT>::get_buffer_allocator(
                allocator),
  ...
  buffer()
      : buffer_mem(
            dimensions, range<dimensions>{detail::index_array{}}, sizeof(T),
            detail::make_base_allocator<T,
                                        AllocatorT>::get_buffer_allocator()) {}
...
class buffer<const T, dimensions, AllocatorT> : public buffer_mem {
  ...
  */
  buffer(const shared_ptr_class<const T>&
         ...
         const range<dimensions>& r, const property_list& propList = {})
      : buffer_mem(
            std::const_pointer_cast<T>(hostPointer), dimensions, r, sizeof(T),
            detail::pointer_origin::shared,
            detail::make_base_allocator<T, AllocatorT>::get_buffer_allocator(),
            propList) {}
