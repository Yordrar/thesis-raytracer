...
*/
#ifndef RUNTIME_INCLUDE_SYCL_SYCL_MATH_BUILTINS_FP_HALF_PRECISION_H_
#define RUNTIME_INCLUDE_SYCL_SYCL_MATH_BUILTINS_FP_HALF_PRECISION_H_
...
#endif  // RUNTIME_INCLUDE_SYCL_SYCL_MATH_BUILTINS_FP_HALF_PRECISION_H_
