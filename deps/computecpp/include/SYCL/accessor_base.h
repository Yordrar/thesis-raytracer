...
#ifndef RUNTIME_INCLUDE_SYCL_ACCESSOR_BASE_H_
#define RUNTIME_INCLUDE_SYCL_ACCESSOR_BASE_H_

#include "SYCL/accessor_args.h"
#include "SYCL/accessor_host_args.h"
...
class COMPUTECPP_EXPORT accessor_base {
  ...
  */
  accessor_base(accessor_base&& rhs);
  ...
  */
  ...
  @return Reference to the new accessor_base.
  */
  accessor_base& operator=(accessor_base&& rhs);
...
class accessor_device_base {
 public:
   ...
   */
  accessor_device_base(access::mode accessMode, access::target accessTarget) {}
  ...
  */
  ...
  accessor_device_base(constructorT constructorRef, access::mode accessMode,
                       access::target accessTarget, size_t elementSize,
                       handler& commandHandler) {}
  ...
  */
  ...
  template class.
  */
  accessor_device_base(dim_t numDims, const detail::index_array& numElements,
                       access::mode accessMode, access::target accessTarget,
                       size_t elementSize, handler& commandHandler) {}
  ...
  */
  ...
  /*!
  @brief Dummy get_store_range() method.
  */
...
#endif  // RUNTIME_INCLUDE_SYCL_ACCESSOR_BASE_H_
